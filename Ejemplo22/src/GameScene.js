...
var GameLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        this.botonIzda.setPosition(
            cc.p(cc.winSize.width*0.7, cc.winSize.height*0.25));

        this.addChild(this.botonIzda);

        this.botonDcha = cc.Sprite.create(res.joypad_png);
        this.botonDcha.setPosition(
            cc.p(cc.winSize.width*0.85, cc.winSize.height*0.25));
        ...
        if (cc.rectContainsPoint(areaBotonIzda,
        ...
        if (cc.rectContainsPoint(areaBotonDcha,
            cc.p(event.getLocationX(), event.getLocationY()) )){
        ...
        if(this.moveLeft){
            var actionMoverGruaX =
                cc.MoveTo.create(Math.abs(this.spriteGrua.x - 0)/500,
                    cc.p(Math.max(this.spriteGrua.x-2, 0),
        ...
        if(this.moveRight){
            var actionMoverGruaX =
                cc.MoveTo.create(Math.abs(this.spriteGrua.x - cc.winSize.width)/500,
                    cc.p(Math.min(this.spriteGrua.x+2, cc.winSize.width),
                        cc.winSize.height*0.9));
            this.spriteGrua.runAction(actionMoverGruaX);
        }
